...
for epoch in "${epochs[@]}"; do
    ...
    for ((run=0; run<1; run++)); do
      ...
      out_dir=/local/scratch/clo37/MED-VLM-MIA-DATA/results/2026_06_27_increasing_epochs_150_members/epoch_${epoch}/run_${run}
      ...
      for ((set=0; set<${#STD_SETS[@]}; set++)); do
        ...
        python /home/clo37/priv/MED-VLM-MIA/mia/mia.py \
            ...
            job_meta_params.description="LOGAN attack for 7B on refinetuned hulumed with TCIA mamograms trained on 150 members with ${epoch} epochs" \
            ...
            data.pre_gen_descriptions=/local/scratch/clo37/MED-VLM-MIA-DATA/results/2026_06_27_increasing_epochs_150_members/epoch_${epoch}/run_0/baselines/datasets/generated_descriptions.json \
