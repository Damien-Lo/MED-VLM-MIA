#!/bin/bash
#SBATCH --job-name=finetuned_test_adapter
#SBATCH --output=out_finetuned_test_adapter.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/MED-VLM-MIA/mia/generate_descriptions.py \
    ...
    \
    path.output_dir=/local/scratch/clo37/MED-VLM-MIA-DATA/test_results/test_generation \
    \
