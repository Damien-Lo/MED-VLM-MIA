...
for mod in "${modalities[@]}"; do
  for ((run=0; run<1; run++)); do
    ...
    out_dir=/local/scratch/clo37/MED-VLM-MIA-DATA/results/2026_08_04_multimodality_hard_BBC_filter/mri/run_0
    ...
    for ((set=0; set<${#STD_SETS[@]}; set++)); do
      ...
      python /home/clo37/priv/MED-VLM-MIA/mia/mia.py \
          ...
          data.pre_gen_descriptions="/local/scratch/clo37/MED-VLM-MIA-DATA/results/2026_08_04_multimodality_hard_BBC_filter/mri/run_0/run_0/baselines/datasets/generated_descriptions.json" \
          \
