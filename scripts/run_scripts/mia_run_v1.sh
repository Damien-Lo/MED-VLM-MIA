#!/bin/bash
#SBATCH --job-name=mia_run_v1
#SBATCH --output=out_mia_run_v1.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
for ((set=0; set<32; set++)); do
    ...
    python /home/clo37/priv/MED-VLM-MIA/mia/mia.py \
        ...
        job_meta_params.description="'First full run of MIA evaluation on hulu_med dataset set ${STD_SETS[$set]}'" \
