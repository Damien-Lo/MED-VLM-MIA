...
for ((mod=0; mod<${#modalities[@]}; mod++)); do
    ...
    out_dir=/local/scratch/clo37/MED-VLM-MIA-DATA/results/2026_03_29/7B_three_images/${modalities[$mod]}/run_${run}/baselines
    ...
    python /home/clo37/priv/MED-VLM-MIA/mia/mia.py \
        ...
        job_meta_params.description="Baselines for 7B on ${modalities[$mod]} data with ${modalities[$mod]} nonmembers with exactly 3 images per sample" \
