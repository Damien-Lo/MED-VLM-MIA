#!/bin/bash
#SBATCH --job-name=eval_endoscopy_run2
#SBATCH --output=/sunhome/clo37/priv/MED-VLM-MIA/scripts/endoscopy_multirun/out_eval_endoscopy_run2.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
data_dir='/local/scratch/clo37/MED-VLM-MIA-DATA/results/ICLR_additional_results/MODERN_PIPELINE_RESULTS/hulumed-endoscopy/run2'
...
for ((set=0; set<${#STD_SETS[@]}; set++)); do
  printf "\n>>>===================\n\nENDOSCOPY RUN2 EVAL -- STD set $set: ${STD_SETS[$set]} \n\n=================== \n\n"
