#!/bin/bash
#SBATCH --job-name=eval_endoscopy_uniform224
#SBATCH --output=/sunhome/clo37/priv/MED-VLM-MIA/scripts/med_resize_scripts/out_eval_endoscopy_uniform224.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
for ((set=0; set<${#STD_SETS[@]}; set++)); do
  printf "\n>>>===================\n\nENDOSCOPY UNIFORM224 EVAL -- STD set $set: ${STD_SETS[$set]} \n\n=================== \n\n"
