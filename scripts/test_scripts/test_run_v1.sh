...
python /home/clo37/priv/MED-VLM-MIA/mia/mia.py \
    ...
    job_meta_params.description="'Test Run 1 seeing if the model is attached and can generate discriptions'" \
    job_meta_params.job_type=evaluation \
    \
    path.output_dir=/home/clo37/priv/MED-VLM-MIA/test_results/TEST_MIA1 \
    \
    ...
    img_metrics.metrics_to_use=["max_k_renyi_05_kl_div","max_k_renyi_1_kl_div","max_k_renyi_2_kl_div","max_k_renyi_inf_kl_div","max_k_renyi_divergence_025","max_k_renyi_divergence_05","max_k_renyi_divergence_2","max_k_renyi_divergence_4"] \
    img_metrics.get_raw_meta_metrics=['losses'] \
    img_metrics.get_proc_meta_metrics=['max_k_renyi_05_kl_div_tkn_vals','max_k_renyi_1_kl_div_tkn_vals','max_k_renyi_2_kl_div_tkn_vals','max_k_renyi_inf_kl_div_tkn_vals','max_k_renyi_divergence_025_tkn_vals','max_k_renyi_divergence_05_tkn_vals','max_k_renyi_divergence_2_tkn_vals','max_k_renyi_divergence_4_tkn_vals'] \
    \
    ...
    data.augmentations.GaussianNoise.std='[1.0,2.5,5.0,25.0,50.0]' \
